 ...
 <li class='active has-sub'><a href='#'>Employee</a>
    ...
    <div class="styled-select">
       <center>
           ...
           <form name="frmUser" method="post" action="get">
...
$query="SELECT * FROM tbl_emp_det,tbl_user where emp_id=fk_emp_id and user_name!='admin@admin.com'";
...
<td><input type="checkbox" name="users[]" value="<?php echo $row["emp_id"]; ?>" ></td>
