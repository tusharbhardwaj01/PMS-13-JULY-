...
<html>
    ...
    <body style=" background-image: url('images/bkg-blu.jpg');">
        ...
        echo "<center>
            <div class='w3-panel w3-light-grey' style='width:92%'>
            <h1>PUBLICATION DETAILS</h1>
            </div>
            <div class='w3-container w3-margin-right w3-margin-top w3-margin-bottom ' style='width:95%'>
        ...
        $sql="SELECT * from tbl_publication";
        $ds=$conn->query($sql);
        ...
        {
        echo "<tr><td>".$result["pub_id"].
                "</td><td>".$result["pub_title"].
                "</td><td>".$result["pub_author"].
                "</td><td>".$result["pub_isbn"].
                "</td><td>".$result["pub_year"].
                "</td><td>".$result["pub_price_inr"].
                "</td><td>".$result["pub_price_usd"].
                "</td><td>".$result["pub_nop"].
                "</td><td>".$result["pub_type"].
                "</td><td>".$result["pub_qty"].
                "</td></tr>";
        }
        }
        echo "</table></div>";
